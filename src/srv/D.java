...
public class D implements Runnable {
	...
	private PrintWriter pwTiempo;
	
	public D (Socket csP, int idP, PrintWriter pwTiempo) {
		sc = csP;
		this.pwTiempo=pwTiempo;
	...
	public void run() {
		...
		//		System.out.println(dlg + "envio llave simetrica al cliente. continuado.");
		   ...
		   //     System.out.println(dlg + "Termino exitosamente.");
				...
				Long tiempoP = tiempoF - tiempoI;
				
	
					pwTiempo.println(tiempoP+"");
			
					
				
				System.out.println("El tiempo de la transacción fue: " + tiempoP + " nanosegundos");
	        } catch (Exception e) {
	        	try {
	        	    sc.close();
